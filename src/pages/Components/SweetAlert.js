        ...
        <div className="container-fluid">
          <div className="card card-plain">
            <div className="header  text-center">
              ...
              <p className="category">A beautiful plugin, that replace the classic alert. Please check out the <a href="https://github.com/chentsulin/sweetalert-react">full documentation.</a></p>
            </div>
            <div className="content">
